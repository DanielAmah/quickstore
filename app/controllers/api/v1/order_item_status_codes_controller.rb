module Api
  module V1
      class OrderItemStatusCodesController < ApplicationController
        ...
        def index
          @order_item_status_codes = OrderItemStatusCode.get_order_item_status_codes
          json_response(@order_item_status_codes)
        end

        def create
          @order_item_status_code = OrderItemStatusCode.create_order_item_status_code(
            order_item_status_code_params)
        ...
        def set_order_item_status_code
          @order_item_status_code = OrderItemStatusCode.find_order_item_status_code(params)
        end
      end
  end 
end