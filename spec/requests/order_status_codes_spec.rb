...
RSpec.describe 'OrderStatusCodes API', type: :request do
  ...
  describe 'GET /order_status_codes' do
    # make HTTP get request before each example
    before { get '/order_status_codes' }
  ...
  describe 'GET /order_status_codes/:id' do
    before { get "/order_status_codes/#{order_status_code_id}" }
  ...
  describe 'POST /order_status_codes' do
    # valid payload
    let(:valid_attributes) { { description: 'Completed' } }

    context 'when the request is valid' do
      before { post '/order_status_codes', params: valid_attributes }
    ...
    context 'when the request is invalid' do
      before { post '/order_status_codes', params: { description: '' } }
  ...
  describe 'PUT /order_status_codes/:id' do
    let(:valid_attributes) { { description: 'Cancelled' } }
    context 'when the record exists' do
      before { put "/order_status_codes/#{order_status_code_id}", params: valid_attributes }
  ...
  describe 'DELETE /order_status_codes/:id' do
    before { delete "/order_status_codes/#{order_status_code_id}" }
